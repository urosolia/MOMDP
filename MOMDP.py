...
class MOMDP(object):
	...
	def locateUR(self, regionType):
		...
		for i in range(0, self.col):
			for j in range(0, self.row):
				if self.gridVar[j,i] == regionType: stateLocation.append(self.stateMap[j,i])
	...
	def initPointBased(self, discOpt):
		...
		# if self.printLevel >= 1: print("Belif points: ", self.numBeliefPoints)
